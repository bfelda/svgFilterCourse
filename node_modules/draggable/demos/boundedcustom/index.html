...
<html>
<head>
	<title>bounded custom demo | draggable.js</title>

	<meta name="viewport" content="user-scalable=no, width=device-width, minimum-scale=1, maximum-scale=1" />

	<link rel="stylesheet" href="../__common/common.css" />
	<link rel="stylesheet" href="boundedcustom.css" />
...
<body>
	...
	<ul id="nav">
		...
		<li><a class="cur" href="#">Bounded (custom)</a></li>
		<li><a href="../grid">Grid</a></li>
	</ul>

	<div id="container">
		<div class="ball blue"></div>
		<div id="drag-bound-indicator"></div>
	</div>
	...
	<script src="boundedcustom.js"></script>
